...
extern "C" DLLAPI int TPV_CreateName_HM_NP_TC12_register_callbacks();
extern "C" DLLAPI int TPV_CreateName_HM_NP_TC12_init_module(int *decision, va_list args);
...
extern "C" DLLAPI int TPV_CreateName_HM_NP_TC12_register_callbacks()
{
    printf("Registruji TPV_CreateName_HM_NP_TC12.dll\n");
    CUSTOM_register_exit("TPV_CreateName_HM_NP_TC12", "USER_init_module", TPV_CreateName_HM_NP_TC12_init_module);
