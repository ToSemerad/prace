...
extern "C" DLLAPI int TPV_Rename_Export_TC10_register_callbacks();
extern "C" DLLAPI int TPV_Rename_Export_TC10_init_module(int *decision, va_list args);
...
extern "C" DLLAPI int TPV_Rename_Export_TC10_register_callbacks()
{
    printf("Registruji TPV_Rename_Export_TC10.dll\n");
    CUSTOM_register_exit("TPV_Rename_Export_TC10", "USER_init_module", TPV_Rename_Export_TC10_init_module);
