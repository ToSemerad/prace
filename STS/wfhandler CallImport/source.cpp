...
extern "C" DLLAPI int TPV_CallImport_TC12_register_callbacks();
extern "C" DLLAPI int TPV_CallImport_TC12_init_module(int *decision, va_list args);
int TPV_CallImport_TC12(EPM_action_message_t msg);
//EPM_decision_t RhTest(EPM_rule_message_t msg);
void ListBomLine(tag_t BomLine, int Level, tag_t RootTask);
extern "C" DLLAPI int TPV_CallImport_TC12_register_callbacks()
{
    printf("Registruji Handler-TPV_CallImport_TC12.dll\n");
    CUSTOM_register_exit("TPV_CallImport_TC12", "USER_init_module",TPV_CallImport_TC12_init_module);
...
extern "C" DLLAPI int TPV_CallImport_TC12_init_module(int *decision, va_list args)
{
    *decision = ALL_CUSTOMIZATIONS;  // Execute all customizations
    ...
    int Status = EPM_register_action_handler("TPV_CallImport_TC12", "",TPV_CallImport_TC12);
