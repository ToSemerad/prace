...
extern "C" DLLAPI int TPV_TC2TPV_TC11_register_callbacks();
extern "C" DLLAPI int TPV_TC2TPV_TC11_init_module(int *decision, va_list args);
int TPV_TC2TPV_TC11(EPM_action_message_t msg);
...
extern "C" DLLAPI int TPV_TC2TPV_TC11_register_callbacks()
{
    printf("Registruji TPV_TC2TPV_TC11.dll\n");
    CUSTOM_register_exit("TPV_TC2TPV_TC11", "USER_init_module", TPV_TC2TPV_TC11_init_module);
...
extern "C" DLLAPI int TPV_TC2TPV_TC11_init_module(int *decision, va_list args)
{
   ...
   //Registrace action handleru
    int Status = EPM_register_action_handler("TPV_TC2TPV_TC11", "", TPV_TC2TPV_TC11);
...
for(i=0;i<m;i++)
{
	printf ("fprint %d \n",i);
	if(i==0)
		fprintf(fp,"POZICE#IDV#ID#NAZEV#REVIZE#MNOZSTVI#PRILOHY#CV_ZAKAZNIK#ZAKAZNIK#POLOTOVAR#POZNAMKA#POZICE#ATRIBUT_2#ATRIBUT_3#OBJEM#PLOCHA#HMOTNOST#HUSTOTA#MATERIAL#TYP\n");
