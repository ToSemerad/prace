...
extern "C" DLLAPI int TPV_Control_Modify_TC11_register_callbacks();
extern "C" DLLAPI int TPV_Control_Modify_TC11_init_module(int *decision, va_list args);
...
extern "C" DLLAPI int TPV_Control_Modify_TC11_register_callbacks()
{
    printf("Registruji TPV_Control_Modify_TC11.dll\n");
    CUSTOM_register_exit("TPV_Control_Modify_TC11", "USER_init_module", TPV_Control_Modify_TC11_init_module);
...
//	   printf ("Count %d \n",itemCount);
	...
	{
		char *item_id;
		char itemType_rev[ITEM_type_size_c];
		date_t rev_last_date,
		   ...
		   ITEM_ask_type(item, itemType_rev);
