...
public class ICCTCAELoadItemRevision extends ICCTItemRevision {
  public ICCTCAELoadItemRevision(Connection connection) {
    super(connection);
  }

  public ICCTCAELoadItemRevision(Connection connection, String typeName, String objectUid) {
    super(connection, typeName, objectUid);
  }

  public void create(String id, String revid, String Name, String Desc, String vaultMode, String eIntType, String[] criteriaNames, String[] criteriaValues, String linkPath, StringHolder CAELoadItemRevisionUid, StringHolder componentTypeUid) throws Exception {
    ...
    InvokeICTMethodResponse response = m_service.invokeICTMethod("ICCTCAELoadItemRevision", "create", args_);
    if( response.serviceData.sizeOfPartialErrors() > 0)
    {
      throw new ICCTException( response.serviceData);
    }
    CAELoadItemRevisionUid.value = TcUtility.queryArg(response.output[0], CAELoadItemRevisionUid.value);
  ...
  public void setVaultData(String revision, String vaultMode, String eIntType, String[] criteriaNames, String[] criteriaValues, String linkPath) throws Exception {
    ...
    InvokeICTMethodResponse response = m_service.invokeICTMethod("ICCTCAELoadItemRevision", "setVaultData", args_);
    if( response.serviceData.sizeOfPartialErrors() > 0)
    {
      throw new ICCTException( response.serviceData);
    }
