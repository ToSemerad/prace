...
public class ICCTReviewTeamDefinition extends ICCT {
  public ICCTReviewTeamDefinition(Connection connection) {
    super(connection);
  }

  public ICCTReviewTeamDefinition(Connection connection, String typeName, String objectUid) {
  ...
  public void create(String group, String role, boolean allowSubgroups, int numToSignoff, StringHolder componentUid, StringHolder componentTypeUid) throws Exception {
    ...
    InvokeICTMethodResponse response = m_service.invokeICTMethod("ICCTReviewTeamDefinition", "create", args_);
